...
def publish_pointcloud(event=None):
    list_centers_x = np.array(obs_x)
    list_centers_y = np.array(obs_y)
...
if __name__ == '__main__':
    try:
        ...
        pcl_pub = rospy.Publisher("/obs_to_pointcloud", PointCloud2, queue_size=10) 
        ...
        rospy.Timer(rospy.Duration(1.0/10.0), publish_pointcloud)
